...
def cam_open(Obj_mainwindow,label1):
    ...
    cap = cv2.VideoCapture(r"C:\Users\kisha\OneDrive\Desktop\MinorProject\aeroplane.mp4")

    classNames = []
    classFile = r"C:\Users\kisha\OneDrive\Desktop\MinorProject\labels.names"

    with open(classFile, 'rt') as f1:
        classNames = f1.read().rstrip('\n').split('\n')

    configPath = r"C:\Users\kisha\OneDrive\Desktop\MinorProject\ssd_mobilenet_v3_large_coco_2020_01_14.pbtxt"
    weightsPath = r"C:\Users\kisha\OneDrive\Desktop\MinorProject\frozen_inference_graph.pb"
...
label1_img= ImageTk.PhotoImage(file = r"C:\Users\kisha\OneDrive\Desktop\MinorProject\gui inside3.jpg")
...
b_img= ImageTk.PhotoImage(file = r"C:\Users\kisha\OneDrive\Desktop\MinorProject\bgbg (2).png")
...
b1_img= ImageTk.PhotoImage(file = r"C:\Users\kisha\OneDrive\Desktop\MinorProject\new start.png")
b2_img= ImageTk.PhotoImage(file = r"C:\Users\kisha\OneDrive\Desktop\MinorProject\stop1 resised.jpg")
